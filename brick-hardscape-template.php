  ...
  <div class="relative z-10 max-w-[1280px] mx-auto px-6 md:px-10 flex flex-col justify-center" style="min-height:88vh;padding-top:140px;padding-bottom:80px;">
    <div class="max-w-2xl">
      <div class="flex items-center gap-3 mb-5">
        ...
        <span class="text-[10px] font-semibold tracking-[.22em] uppercase text-[#d4aa6a]">Brick + Hardscapes</span>
      </div>
      <h1 class="font-['Playfair_Display'] text-[clamp(38px,6vw,72px)] font-bold text-[#f0ece6] leading-[1.06] tracking-tight mb-5">
        Crafted to Last.<br>
        <em class="italic text-[#d4aa6a]">Designed to Impress.</em>
      </h1>
      ...
      <div class="flex flex-wrap gap-3">
        <a href="/contact" class="inline-flex items-center gap-2 text-[12px] font-bold tracking-[.1em] uppercase text-[#0f0f0f] px-7 py-4 rounded-md hover:opacity-85 transition-opacity"
        ...
        <a href="#ev-gallery" class="inline-flex items-center gap-2 text-[12px] font-medium tracking-[.08em] uppercase text-[rgba(240,236,230,.75)] border border-[rgba(240,236,230,.2)] px-7 py-4 rounded-md hover:text-[#d4aa6a] hover:border-[#d4aa6a] transition-colors">
          View Our Work
        </a>
      </div>
    </div>
  ...
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 items-start">
      ...
      <div class="ev-reveal-left">
        <span class="block text-[10px] font-semibold tracking-[.22em] uppercase text-[#d4aa6a] mb-4">What We Build</span>
        <h2 class="font-['Playfair_Display'] text-[clamp(28px,3.5vw,44px)] font-bold text-[#1a1814] leading-[1.12] mb-7">
          ...
          <span class="text-[#d4aa6a]">to Perform for Decades.</span>
        </h2>
        <div class="space-y-5 text-[15px] font-light text-[#6a6560] leading-[1.8]">
          <p>Everridge designs and constructs outdoor structures that transform how you use and experience your property. Our hardscape services include <strong class="font-semibold text-[#1a1814]">paver patios, walkways, driveways, and entryways</strong> using premium interlocking pavers from leading manufacturers. We build outdoor fireplaces and fire pit areas that extend your living space into the outdoors year round. Our retaining walls solve grading and drainage challenges while adding visual depth and structure to your landscape.</p>
          <p>We also provide <strong class="font-semibold text-[#1a1814]">paver repair and restoration</strong> services — including releveling, joint sand replacement, and polymeric sand application — to bring existing installations back to like-new condition.</p>
          <p>Every hardscape project we build is designed to last. We use proper base preparation, compaction techniques, and drainage integration to ensure that your patio, walkway, or wall performs as well in year 15 as it does on day one. <strong class="font-semibold text-[#1a1814]">We do not cut corners on the work you cannot see</strong> — because that is the work that determines how long your investment lasts.</p>
        </div>
      ...
      <div class="ev-reveal-right flex flex-col gap-4 lg:sticky lg:top-32">
        <div class="rounded-2xl overflow-hidden border border-[#e8e2da] aspect-[4/5] bg-[#e0ddd6] flex items-center justify-center text-[11px] text-[#b0aaa2] text-center px-8">
        ...
        <!-- Material badge -->
        <div class="bg-[#f7f3ee] border border-[#e8e2da] rounded-xl p-5 flex items-start gap-4">
          ...
          <div>
            <div class="text-[12px] font-semibold text-[#1a1814] mb-1">Premium Materials Only</div>
            <p class="text-[12px] font-light text-[#6a6560] leading-relaxed">We work exclusively with Unilock, Techo-Bloc, and natural stone products rated for Michigan's freeze-thaw cycles.</p>
          </div>
        </div>
      </div>
    ...
    <div id="ev-gallery" class="mt-20">
      <div class="text-center mb-10 ev-reveal">
        ...
        <h3 class="font-['Playfair_Display'] text-[clamp(24px,3vw,36px)] font-bold text-[#1a1814]">Our Hardscape Work</h3>
      </div>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php foreach ( $project_types as $i => $pt ) : ?>
        <div class="ev-reveal group relative overflow-hidden rounded-xl border border-[#e8e2da] aspect-[4/3] cursor-pointer bg-[#e0ddd6]"
          ...
          <div class="absolute inset-0 flex items-center justify-center text-[10px] text-[#b0aaa2] text-center px-6 transition-transform duration-500 group-hover:scale-105">
            <?php echo $pt['ph']; ?>
          </div>
...
<section class="bg-[#f7f3ee] border-t border-b border-[#e8e2da] py-24">
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="text-center mb-14 ev-reveal">
      <span class="block text-[10px] font-semibold tracking-[.22em] uppercase text-[#d4aa6a] mb-3">Materials</span>
      <h2 class="font-['Playfair_Display'] text-[clamp(26px,3.5vw,42px)] font-bold text-[#1a1814] leading-[1.15]">
        ...
        <span class="text-[#d4aa6a]">Last the Michigan Winter.</span>
      </h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
      ...
      <div class="ev-reveal bg-white border border-[#e8e2da] rounded-2xl overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
           style="transition-delay:<?php echo $i * 100; ?>ms;">
        <!-- Image -->
        <div class="aspect-video bg-[#e0ddd6] flex items-center justify-center text-[10px] text-[#b0aaa2] text-center px-8">
        ...
        <div class="p-6">
          <div class="flex items-start gap-4">
            <div class="w-9 h-9 rounded-lg bg-[#f7f3ee] border border-[#e8e2da] flex items-center justify-center flex-shrink-0 mt-0.5">
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="#d4aa6a" stroke-width="1.6">
                <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo $m['icon']; ?>"/>
              </svg>
            </div>
            <div>
              <h3 class="font-['Playfair_Display'] text-[17px] font-bold text-[#1a1814] mb-1"><?php echo $m['title']; ?></h3>
              <div class="text-[10px] font-semibold tracking-[.1em] uppercase text-[#d4aa6a] mb-2"><?php echo $m['brands']; ?></div>
              <p class="text-[13px] font-light text-[#6a6560] leading-[1.7]"><?php echo $m['copy']; ?></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="text-center mb-14 ev-reveal">
      ...
      <h2 class="font-['Playfair_Display'] text-[clamp(26px,3.5vw,42px)] font-bold text-[#1a1814]">
        ...
        <span class="text-[#d4aa6a]">We Make.</span>
      </h2>
      <p class="mt-3 text-[14px] text-[#8a8680] font-light">Drag the handle left and right to reveal the transformation.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="ev-reveal" style="transition-delay:<?php echo ($i%2)*100; ?>ms;">
        <div class="ev-ba relative overflow-hidden rounded-2xl border border-[#e8e2da] cursor-col-resize select-none" data-ba="<?php echo $i; ?>">
          <!-- Before -->
          <div class="aspect-[4/3] bg-[#ddd8d0] flex items-center justify-center text-[10px] text-[#b0aaa2] text-center px-8">
            {{-- Before img: background-image:url('<?php echo get_template_directory_uri(); ?>/assets/images/hs-before-<?php echo $i+1; ?>.jpg') --}}
            <?php echo $p['ph_b']; ?>
          </div>
          <!-- After (clipped) -->
          <div class="ev-ba-after absolute inset-0 bg-[#c8d4b8] flex items-center justify-center text-[10px] text-[#b0aaa2] text-center px-8"
...
<section class="bg-[#f7f3ee] border-t border-b border-[#e8e2da] py-24">
  <div class="max-w-[1100px] mx-auto px-6 md:px-10">
    ...
    <div class="text-center mb-20 ev-reveal">
      <span class="block text-[10px] font-semibold tracking-[.22em] uppercase text-[#d4aa6a] mb-3">How It Works</span>
      <h2 class="font-['Playfair_Display'] text-[clamp(26px,3.5vw,42px)] font-bold text-[#1a1814] leading-[1.18]">
        Your Project, Step by Step.<br>
        <span class="text-[#d4aa6a]">No Surprises. No Shortcuts.</span>
      </h2>
    </div>
    ...
    <div class="relative">
      ...
      <div class="ev-step relative grid grid-cols-1 md:grid-cols-[1fr_52px_1fr] items-center <?php echo $i < 3 ? 'mb-16' : ''; ?>"
        ...
        <?php if ( $left ) : ?>
          ...
          <div class="md:pr-14 md:text-right mb-6 md:mb-0">
            <div class="inline-flex items-center gap-2 mb-3 <?php echo $left ? 'md:flex-row-reverse' : ''; ?>">
              <span class="text-[10px] font-bold tracking-[.18em] uppercase text-[#d4aa6a]">Step <?php echo $step['num']; ?></span>
            </div>
          ...
          <!-- Dot -->
          <div class="ev-step-dot hidden md:flex w-[52px] h-[52px] flex-shrink-0 rounded-full items-center justify-center bg-white border-2 border-[#e0dad2] z-10 transition-all duration-500 mx-auto shadow-sm">
            <span class="font-['Playfair_Display'] text-[13px] font-bold text-[#d4aa6a]"><?php echo $step['num']; ?></span>
          </div>
          <!-- Image right -->
          <div class="md:pl-14">
            <div class="rounded-xl border border-[#e8e2da] bg-[#e8e4de] h-48 flex items-center justify-center text-[10px] text-[#b0aaa2] text-center px-6">
              {{-- Replace: <img src="<?php echo get_template_directory_uri(); ?>/assets/images/process-hs-<?php echo $i+1; ?>.jpg" class="w-full h-full object-cover rounded-xl" loading="lazy"> --}}
              <?php echo $step['ph']; ?>
            </div>
          </div>
        ...
        <?php else : ?>
          ...
          <!-- Content right -->
          <div class="md:pl-14">
            <div class="text-[10px] font-bold tracking-[.18em] uppercase text-[#d4aa6a] mb-3">Step <?php echo $step['num']; ?></div>
            <h3 class="font-['Playfair_Display'] text-xl font-bold text-[#1a1814] mb-3"><?php echo $step['title']; ?></h3>
            <p class="text-[13px] font-light text-[#6a6560] leading-[1.75]"><?php echo $step['copy']; ?></p>
          </div>
        <?php endif; ?>
...
<section class="bg-white py-24">
  <div class="max-w-[860px] mx-auto px-6 md:px-10 ev-reveal">
    <div class="bg-[#f7f3ee] border border-[#e8e2da] rounded-2xl p-10 md:p-14 text-center relative overflow-hidden">
      ...
      <p class="font-['Playfair_Display'] italic text-[clamp(17px,2.5vw,22px)] text-[#1a1814] leading-[1.65] mb-8 relative z-10">
      ...
      <div class="flex items-center justify-center gap-4">
        <div class="w-12 h-12 rounded-full bg-[#e0ddd6] flex items-center justify-center flex-shrink-0">
          <span class="font-['Playfair_Display'] text-[15px] font-bold text-[#8a7a6a]">DM</span>
        </div>
        <div class="text-left">
          <div class="font-semibold text-[14px] text-[#1a1814]">David M.</div>
          <div class="text-[11px] text-[#8a8680]">Paver Patio + Seating Wall · Birmingham, MI</div>
        </div>
        <!-- Google badge -->
        <div class="ml-4 flex items-center gap-1.5 bg-white border border-[#e8e2da] rounded-full px-3 py-1.5">
  ...
  <div class="max-w-[800px] mx-auto px-6 md:px-10">
    ...
    <div class="text-center mb-14 ev-reveal">
      ...
      <h2 class="font-['Playfair_Display'] text-[clamp(26px,3.5vw,40px)] font-bold text-[#1a1814] leading-[1.15]">
        ...
        <span class="text-[#d4aa6a]">Hardscape Projects</span>
      </h2>
    </div>

    <div id="ev-faq" class="flex flex-col gap-3 ev-reveal">
      <?php foreach ( $faqs as $i => $faq ) : ?>
      <div class="ev-faq-item bg-white border border-[#e8e2da] rounded-xl overflow-hidden transition-all duration-300 hover:border-[#d4aa6a]">
...
<section class="relative overflow-hidden py-24 md:py-32">
  ...
  <div class="relative z-10 max-w-[720px] mx-auto px-6 md:px-10 text-center">
    ...
    <h2 class="font-['Playfair_Display'] text-[clamp(30px,5vw,54px)] font-bold text-[#f0ece6] leading-[1.1] mb-5">
      Ready to Build Something<br>
      <em class="italic text-[#d4aa6a]">That Lasts?</em>
    </h2>
  ...
  const so = new IntersectionObserver(entries => {
    entries.forEach(e => {
      ...
      if (stepDots[i]) {
        ...
        stepDots[i].style.background   = 'rgba(212,170,106,.1)';
        stepDots[i].style.boxShadow    = '0 0 0 4px rgba(212,170,106,.12)';
      }
