...
?>
  ...
  <div class="relative z-10 max-w-[1280px] mx-auto px-6 md:px-10 flex flex-col justify-end pb-16 md:pb-20" style="min-height:52vh;padding-top:130px;">
    ...
    <h1 class="font-['Articulat_CF'] text-[clamp(36px,5.5vw,68px)] font-bold text-[#e6e3df] leading-[1.08] tracking-tight max-w-3xl">
      ...
      <span class="text-[#8a6a45]">Driven by Precision.</span>
    </h1>
...
<section class="bg-white py-24">
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    <div class="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 lg:gap-24 items-start">
      ...
      <div class="ev-reveal-left">
        ...
        <h2 class="font-['Articulat_CF'] text-[clamp(28px,3.5vw,44px)] font-bold text-[#0b0b0c] leading-[1.12] mb-8">
          From the Ground Up.<br>
          <span class="text-[#8a6a45]">Every Detail, Every Time.</span>
        </h2>
        <div class="space-y-5 text-[15px] font-light text-[#7a7f85] leading-[1.8]">
          <p>Everridge Landscape & Hardscape was built on 17 years of hands-on experience in outdoor construction and design. Our founder, <strong class="font-semibold text-[#0b0b0c]">Hernan Chavarin</strong>, started working in the landscaping and hardscape industry in 2008, learning the craft from the ground up. Every aspect of the trade — from grading and drainage to paver installation, retaining wall construction, and garden design — was learned through years of physical work, problem solving, and dedication to getting every detail right.</p>
          <p>The company was formally established as an LLC in 2021, and in 2026 we made the decision to rebrand as Everridge Landscape & Hardscape. This was not just a name change. It was a commitment to the premium positioning that our work has always deserved. <strong class="font-semibold text-[#0b0b0c]">Everridge represents who we are now:</strong> a design and build firm that transforms outdoor spaces for homeowners who expect more than average.</p>
          <p>Today, we operate from Clinton Township, Michigan with a team of 4 specialists who share the same obsession with quality. We serve homeowners across the Oakland-Macomb corridor — from Bloomfield Hills and Birmingham to Troy, Rochester Hills, Shelby Township, and Washington Township.</p>
        </div>
        ...
        <div class="mt-12 space-y-0">
          ...
          <div class="flex gap-5 <?php echo $i < count($milestones) - 1 ? 'pb-8' : ''; ?> relative">
            ...
            <?php endif; ?>
            <div class="flex-shrink-0 w-10 h-10 border-2 border-[#8a6a45] bg-white flex items-center justify-center z-10">
              <div class="w-2 h-2 bg-[#8a6a45]"></div>
            </div>
            <div class="pt-1.5">
              <div class="flex items-center gap-3 mb-1">
                <span class="font-['Articulat_CF'] text-[13px] font-bold text-[#8a6a45]"><?php echo $m['year']; ?></span>
                <span class="text-[13px] font-semibold text-[#0b0b0c]"><?php echo $m['label']; ?></span>
              </div>
              <p class="text-[13px] text-[#7a7f85] leading-relaxed"><?php echo $m['copy']; ?></p>
            </div>
          </div>
          <?php endforeach; ?>
        </div>
  ...
  <?php
        ...
        <!-- Quote card -->
        <div class="bg-[#f5f2ef] border border-[#e6e3df] p-6">
          <svg class="w-7 h-7 text-[#8a6a45] mb-3 opacity-60" fill="currentColor" viewBox="0 0 24 24">
            <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
          </svg>
          <p class="font-['Articulat_CF'] italic text-[15px] text-[#2f3133] leading-[1.7]">
          ...
          <div class="mt-4 pt-4 border-t border-[#e6e3df] flex items-center gap-3">
            <div class="w-8 h-8 bg-[#8a6a45] flex items-center justify-center flex-shrink-0">
              <span class="text-[11px] font-bold text-white">HC</span>
            </div>
            <div>
              <div class="text-[12px] font-semibold text-[#0b0b0c]">Hernan Chavarin</div>
              <div class="text-[10px] text-[#7a7f85]">Founder, Everridge</div>
            </div>
          </div>
        </div>
      </div>
...
<section class="bg-[#f5f2ef] border-t border-b border-[#e6e3df] py-24">
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="text-center mb-16 ev-reveal">
      <span class="block text-[10px] font-semibold tracking-[.22em] uppercase text-[#8a6a45] mb-3">Our Difference</span>
    ...
    <?php
    $diffs = [
      [ 'num' => '01', 'title' => 'Custom 3D Renderings',          'copy' => 'Before we break ground on any project, we create a photorealistic visualization of the finished result. You see your property transformed — from multiple angles — with the exact materials and layout we will use. This eliminates the anxiety every homeowner feels: the fear that the result won\'t match the expectation.', 'icon' => 'M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z M15 12a3 3 0 11-6 0 3 3 0 016 0z' ],
      [ 'num' => '02', 'title' => 'Premium Hardscape Installation', 'copy' => 'We use only top-tier pavers, natural stone, and commercial-grade materials. No cutting corners. No substitutions. Every hardscape installation is engineered for Michigan\'s freeze-thaw cycle and built to last 20+ years. The craftsmanship shows in every joint line and every leveled surface.', 'icon' => 'M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085' ],
      [ 'num' => '03', 'title' => 'Professional Garden Design',     'copy' => 'Landscape and garden design is not a secondary service for us — it is a core discipline. We design planting plans that consider seasonal color, mature size, soil conditions, and long-term maintenance. The result is a landscape that looks intentional, curated, and professionally maintained.', 'icon' => 'M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z' ],
      [ 'num' => '04', 'title' => 'Complete Outdoor Lighting',      'copy' => 'Outdoor lighting is the final layer of a premium property transformation. We design and install full lighting systems — accent lights on trees, pathway illumination, and architectural uplighting — that elevate the presence of your home after dark and add security, ambiance, and measurable value.', 'icon' => 'M12 3v1m0 16v1m-8-9H3m18 0h-1m-2.05-5.95l-.707.707M6.757 17.243l-.707.707m12.193 0l-.707-.707M6.757 6.757l-.707-.707M12 7a5 5 0 100 10A5 5 0 0012 7z' ],
    ];
    ?>

    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
      <?php foreach ( $diffs as $i => $d ) : ?>
      <div class="ev-reveal group bg-white border border-[#e6e3df] p-8 hover:border-[#8a6a45] hover:shadow-[0_8px_40px_rgba(138,106,69,.1)] transition-all duration-300"
           style="transition-delay:<?php echo $i * 100; ?>ms;">
        <div class="flex items-start gap-5">
          <div class="flex-shrink-0 w-12 h-12 bg-[#f5f2ef] border border-[#e6e3df] flex items-center justify-center group-hover:bg-[#fdf8ee] group-hover:border-[#e8d8b0] transition-colors">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="#8a6a45" stroke-width="1.6">
              <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo $d['icon']; ?>"/>
            </svg>
          </div>
          <div>
            <div class="text-[10px] font-bold text-[#8a6a45] tracking-[.15em] uppercase mb-1"><?php echo $d['num']; ?></div>
            <h3 class="font-['Articulat_CF'] text-[18px] font-bold text-[#0b0b0c] mb-3 leading-snug"><?php echo $d['title']; ?></h3>
            <p class="text-[13px] font-light text-[#7a7f85] leading-[1.75]"><?php echo $d['copy']; ?></p>
          </div>
        </div>
      </div>
      <?php endforeach; ?>
...
<section class="bg-white py-24">
  <div class="max-w-[860px] mx-auto px-6 md:px-10 text-center ev-reveal">
    <span class="block text-[10px] font-semibold tracking-[.22em] uppercase text-[#8a6a45] mb-4">Our Mission</span>
    <h2 class="font-['Articulat_CF'] text-[clamp(26px,4vw,48px)] font-bold text-[#0b0b0c] leading-[1.15] mb-6">
      We Exist to Elevate<br>
      <span class="text-[#8a6a45]">Every Property We Touch.</span>
    </h2>
    <div class="flex items-center justify-center gap-4 mb-8">
      <span class="block w-16 h-px bg-[#e8e2da]"></span>
      <svg class="w-4 h-4 text-[#8a6a45]" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
      <span class="block w-16 h-px bg-[#e8e2da]"></span>
    </div>
    <p class="text-[17px] font-light text-[#7a7f85] leading-[1.85] max-w-2xl mx-auto">
    ...
    <p class="mt-5 text-[17px] font-light text-[#7a7f85] leading-[1.85] max-w-2xl mx-auto">
...
<section class="bg-[#f5f2ef] border-t border-b border-[#e6e3df] py-24">
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="text-center mb-16 ev-reveal">
      <span class="block text-[10px] font-semibold tracking-[.22em] uppercase text-[#8a6a45] mb-3">Credentials</span>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-5 mb-16">
      ...
      <div class="ev-reveal bg-white border border-[#e6e3df] p-8 text-center hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
           style="transition-delay:<?php echo $i * 80; ?>ms;">
        <div class="font-['Articulat_CF'] text-[clamp(36px,4vw,52px)] font-bold leading-none mb-2">
          <span class="ev-counter text-[#0b0b0c]" data-target="<?php echo $s['value']; ?>"><?php echo $s['value']; ?></span><span class="text-[#8a6a45]"><?php echo $s['suffix']; ?></span>
        </div>
        <div class="text-[13px] font-semibold text-[#0b0b0c] mb-1"><?php echo $s['label']; ?></div>
        <div class="text-[11px] text-[#7a7f85]"><?php echo $s['sub']; ?></div>
      </div>
      <?php endforeach; ?>
    </div>
    ...
    <?php
    $trust_items = [
      [ 'icon' => 'M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z', 'title' => 'Licensed & Insured',       'copy' => 'Fully licensed in the State of Michigan with landscaping and agricultural licenses. General liability and workers compensation coverage protect your property from day one through final walkthrough.' ],
      [ 'icon' => 'M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.562.562 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z', 'title' => '5-Star Rated on Angi',    'copy' => 'Consistently rated 5 stars by verified homeowners on Angi. Our reviews reflect the same commitment to quality, communication, and clean job sites that defines every Everridge project.' ],
      [ 'icon' => 'M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z', 'title' => '17+ Years of Experience', 'copy' => 'Hernan Chavarin has been in the field since 2008. That hands-on experience means we understand drainage, soil conditions, frost lines, and material performance in ways that less experienced contractors simply do not.' ],
      [ 'icon' => 'M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z', 'title' => 'Residential & Commercial', 'copy' => 'We serve both residential homeowners and commercial property clients across Southeast Michigan. Whether it is a private residence in Birmingham or a commercial property in Troy, the standard of work never changes.' ],
      [ 'icon' => 'M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z M15 12a3 3 0 11-6 0 3 3 0 016 0z', 'title' => 'Free Consultations',       'copy' => 'Every project starts with a free, no-obligation on-site consultation. We come to your property, walk the space with you, listen to your vision, and assess the scope. There is no pressure and no cost.' ],
      [ 'icon' => 'M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0l4.179 2.25L12 21.75 2.25 16.5l4.179-2.25m11.142 0l-5.571 3-5.571-3', 'title' => '3D Renderings Included',  'copy' => 'Every project includes a custom 3D rendering before construction begins. You approve the design before we touch your property. This is not a paid add-on. It is a standard part of how we work.' ],
    ];
    ?>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
      <?php foreach ( $trust_items as $i => $t ) : ?>
      <div class="ev-reveal bg-white border border-[#e6e3df] p-6 hover:border-[#8a6a45] hover:shadow-[0_4px_24px_rgba(138,106,69,.08)] transition-all duration-300"
           style="transition-delay:<?php echo $i * 80; ?>ms;">
        <div class="w-10 h-10 bg-[#f5f2ef] border border-[#e6e3df] flex items-center justify-center mb-4">
          <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="#8a6a45" stroke-width="1.6">
            <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo $t['icon']; ?>"/>
          </svg>
        </div>
        <h3 class="font-['Articulat_CF'] text-[16px] font-bold text-[#0b0b0c] mb-2"><?php echo $t['title']; ?></h3>
        <p class="text-[13px] font-light text-[#7a7f85] leading-[1.75]"><?php echo $t['copy']; ?></p>
      </div>
      <?php endforeach; ?>
    </div>
    ...
    <div class="mt-14 ev-reveal">
      <div class="bg-white border border-[#e6e3df] px-8 py-5 flex flex-wrap items-center justify-between gap-6">
        <div class="flex items-center gap-3">
          <svg class="w-5 h-5 text-[#8a6a45] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z"/></svg>
          <div>
            <div class="text-[11px] font-semibold text-[#0b0b0c]">Michigan Contractor License</div>
            <div class="text-[10px] text-[#7a7f85]">Landscaping & Agricultural · Licensed & Insured</div>
          </div>
        </div>
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="text-[11px] font-semibold text-[#0b0b0c]">General Liability Insurance</div>
            <div class="text-[10px] text-[#7a7f85]">Workers compensation · Full coverage</div>
          </div>
        </div>
        <div class="w-px h-8 bg-[#e8e2da] hidden md:block"></div>
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="text-[11px] font-semibold text-[#0b0b0c]">5-Star Rated on Angi</div>
            <div class="text-[10px] text-[#7a7f85]">Verified homeowner reviews</div>
          </div>
        </div>
        <div class="w-px h-8 bg-[#e8e2da] hidden md:block"></div>
        <div class="text-[11px] text-[#7a7f85] italic max-w-[200px]">
...
?>
  ...
  <div class="relative z-10 max-w-[720px] mx-auto px-6 md:px-10 text-center">
    <span class="block text-[10px] font-semibold tracking-[.22em] uppercase text-[#8a6a45] mb-4">Work With Us</span>
    <h2 class="font-['Articulat_CF'] text-[clamp(28px,4.5vw,52px)] font-bold text-[#e6e3df] leading-[1.1] mb-5">
      Ready to Work With a Team<br>
      <span class="text-[#8a6a45]">That Gets It Right?</span>
    </h2>
