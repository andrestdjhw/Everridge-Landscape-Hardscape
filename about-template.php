...
<section class="relative overflow-hidden -mt-[68px] md:-mt-[106px]" style="min-height:52vh;">
  ...
  <div class="relative z-10 max-w-[1280px] mx-auto px-6 md:px-10 flex flex-col justify-end pb-16 md:pb-20" style="min-height:52vh;padding-top:130px;">
    ...
    <h1 class="font-['Playfair_Display'] text-[clamp(36px,5.5vw,68px)] font-bold text-[#e6e3df] leading-[1.08] tracking-tight max-w-3xl">
      Built on Expertise.<br>
      <em class="italic text-[#8a6a45]">Driven by Precision.</em>
    </h1>
  ...
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 lg:gap-24 items-start">
      ...
      <div class="ev-reveal-left">
        ...
        <h2 class="font-['Playfair_Display'] text-[clamp(28px,3.5vw,44px)] font-bold text-[#0b0b0c] leading-[1.12] mb-8">
        ...
        <div class="mt-12 space-y-0">
          ...
          <div class="flex gap-5 <?php echo $i < count($milestones) - 1 ? 'pb-8' : ''; ?> relative">
            ...
            <?php endif; ?>
            <!-- Dot -->
            <div class="flex-shrink-0 w-10 h-10 rounded-full border-2 border-[#8a6a45] bg-white flex items-center justify-center z-10">
              <div class="w-2 h-2 rounded-full bg-[#8a6a45]"></div>
            </div>
            <!-- Content -->
            <div class="pt-1.5">
              <div class="flex items-center gap-3 mb-1">
                <span class="font-['Playfair_Display'] text-[13px] font-bold text-[#8a6a45]"><?php echo $m['year']; ?></span>
      ...
      <div class="ev-reveal-right flex flex-col gap-5 lg:sticky lg:top-32">
        <!-- Founder photo -->
        <div class="relative rounded-2xl overflow-hidden border border-[#e6e3df]">
          ...
          <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[rgba(0,0,0,.7)] to-transparent px-6 pt-10 pb-6">
            <div class="font-['Playfair_Display'] text-lg font-bold text-[#e6e3df]">Hernan Chavarin</div>
            <div class="text-[11px] text-[#8a6a45] tracking-[.1em] uppercase mt-0.5">Founder & Lead Designer</div>
          </div>
        </div>

        <!-- Quote card -->
        <div class="bg-[#f5f2ef] border border-[#e6e3df] rounded-xl p-6">
          ...
          <p class="font-['Playfair_Display'] italic text-[15px] text-[#2f3133] leading-[1.7]">
          ...
          <div class="mt-4 pt-4 border-t border-[#e6e3df] flex items-center gap-3">
            <div class="w-8 h-8 rounded-full bg-[#8a6a45] flex items-center justify-center flex-shrink-0">
...
<section class="bg-[#f5f2ef] border-t border-b border-[#e6e3df] py-24">
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
      ...
      <div class="ev-reveal group bg-white border border-[#e6e3df] rounded-2xl p-8 hover:border-[#8a6a45] hover:shadow-[0_8px_40px_rgba(138,106,69,.1)] transition-all duration-300"
           style="transition-delay:<?php echo $i * 100; ?>ms;">
        <div class="flex items-start gap-5">
          <div class="flex-shrink-0 w-12 h-12 rounded-xl bg-[#f5f2ef] border border-[#e6e3df] flex items-center justify-center group-hover:bg-[#fdf8ee] group-hover:border-[#e8d8b0] transition-colors">
          ...
          <div>
            ...
            <h3 class="font-['Playfair_Display'] text-[18px] font-bold text-[#0b0b0c] mb-3 leading-snug"><?php echo $d['title']; ?></h3>
    ...
    <div class="ev-reveal">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#e8e2da] rounded-2xl overflow-hidden border border-[#e6e3df]">
...
<section class="bg-white py-24">
  <div class="max-w-[860px] mx-auto px-6 md:px-10 text-center ev-reveal">
    ...
    <h2 class="font-['Playfair_Display'] text-[clamp(26px,4vw,48px)] font-bold text-[#0b0b0c] leading-[1.15] mb-6">
      We Exist to Elevate<br>
      <em class="italic text-[#8a6a45]">Every Property We Touch.</em>
    </h2>
    <!-- Decorative line -->
...
<section class="bg-[#f5f2ef] border-t border-b border-[#e6e3df] py-24">
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-5 mb-16">
      ...
      <div class="ev-reveal bg-white border border-[#e6e3df] rounded-2xl p-8 text-center hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <div class="ev-reveal bg-white border border-[#e6e3df] rounded-xl p-6 hover:border-[#8a6a45] hover:shadow-[0_4px_24px_rgba(138,106,69,.08)] transition-all duration-300"
           style="transition-delay:<?php echo $i * 80; ?>ms;">
        <div class="w-10 h-10 rounded-lg bg-[#f5f2ef] border border-[#e6e3df] flex items-center justify-center mb-4">
          <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="#8a6a45" stroke-width="1.6">
            <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo $t['icon']; ?>"/>
          </svg>
        </div>
        <h3 class="font-['Playfair_Display'] text-[16px] font-bold text-[#0b0b0c] mb-2"><?php echo $t['title']; ?></h3>
    ...
    <div class="mt-14 ev-reveal">
      <div class="bg-white border border-[#e6e3df] rounded-xl px-8 py-5 flex flex-wrap items-center justify-between gap-6">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="text-[10px] text-[#7a7f85]">Landscaping & Agricultural · GA Lic. #CN-204817</div>
          </div>
        </div>
...
<section class="relative overflow-hidden py-24 md:py-32">
  ...
  <div class="relative z-10 max-w-[720px] mx-auto px-6 md:px-10 text-center">
    ...
    <h2 class="font-['Playfair_Display'] text-[clamp(28px,4.5vw,52px)] font-bold text-[#e6e3df] leading-[1.1] mb-5">
      Ready to Work With a Team<br>
      <em class="italic text-[#8a6a45]">That Gets It Right?</em>
    </h2>
    ...
    <a href="tel:+17705550192"
       class="block font-['Playfair_Display'] font-bold text-[#8a6a45] text-[clamp(26px,4vw,42px)] mb-9 hover:opacity-75 transition-opacity tracking-tight">
      (770) 555-0192
    </a>
