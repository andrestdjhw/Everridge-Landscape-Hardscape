  ...
  <div class="relative z-10 max-w-[1280px] mx-auto px-6 md:px-10 flex flex-col justify-center" style="min-height:88vh;padding-top:140px;padding-bottom:80px;">
    ...
    <div class="absolute bottom-10 right-6 md:right-10 hidden md:flex flex-col gap-3">
      ...
      <div class="bg-[rgba(10,10,8,.75)] backdrop-blur-md border border-[rgba(255,255,255,.08)] px-5 py-3 text-right">
        <div class="font-['Articulat_CF'] text-[16px] font-bold text-[#8a6a45] leading-none"><?php echo $b[0]; ?></div>
  ...
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="mt-20">
      <div class="text-center mb-10 ev-reveal">
        ...
        <h3 class="font-['Articulat_CF'] text-[clamp(22px,3vw,34px)] font-bold text-[#0b0b0c]">Our Landscape Work</h3>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-10 items-start">
        ...
        <div class="bg-[#f5f2ef] border border-[#e6e3df] p-8 md:p-10">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="font-['Articulat_CF'] text-[22px] font-bold text-[#0b0b0c]"><?php echo $season['label']; ?> Services</h3>
          </div>
          <div class="space-y-3">
          ...
          <div class="mt-8 pt-6 border-t border-[#d8d4ce]">
            <a href="/contact"
               class="inline-flex items-center gap-2 text-[11px] font-bold tracking-[.1em] uppercase text-[#0f0f0f] px-6 py-3 hover:opacity-85 transition-opacity"
               style="background:linear-gradient(135deg,#8a6a45,#7a5c38);">
  ...
  <div class="max-w-[860px] mx-auto px-6 md:px-10 ev-reveal">
    <div class="bg-white border border-[#e6e3df] p-10 md:p-14 text-center relative overflow-hidden">
      ...
      <div class="flex items-center justify-center gap-4">
        <div class="w-12 h-12 bg-[#e8f0e4] flex items-center justify-center flex-shrink-0">
          <span class="font-['Articulat_CF'] text-[15px] font-bold text-[#4a7a4a]">KL</span>
        </div>
        <div class="text-left">
