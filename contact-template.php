...
<section class="bg-white py-20">
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    <div class="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-12 items-start">
      ...
      <!-- LEFT — form -->
      <div class="bg-[#f5f2ef] border border-[#e6e3df] overflow-hidden">
        <!-- Dark header strip -->
        <div class="bg-[#0b0b0c] px-10 py-7">
          ...
          <h2 class="font-['Articulat_CF'] text-[clamp(22px,2.8vw,30px)] font-bold text-[#e6e3df] leading-snug">
        ...
        <!-- ContactForm mount — light mode (no data-dark-mode) -->
      ...
      <div class="flex flex-col gap-6 lg:sticky lg:top-32">
        ...
        <!-- Contact info -->
        <div class="bg-[#f5f2ef] border border-[#e6e3df] p-7">
          <h3 class="font-['Articulat_CF'] text-[18px] font-bold text-[#0b0b0c] mb-5">Get in Touch</h3>
          <div class="flex flex-col gap-4">

            <a href="tel:+17705550192" class="flex items-center gap-4 group">
              <div class="w-10 h-10 bg-white border border-[#e6e3df] flex items-center justify-center flex-shrink-0 group-hover:border-[#8a6a45] transition-colors">
            ...
            <a href="mailto:info@everridgeus.com" class="flex items-center gap-4 group">
              <div class="w-10 h-10 bg-white border border-[#e6e3df] flex items-center justify-center flex-shrink-0 group-hover:border-[#8a6a45] transition-colors">
              ...
              <div>
                ...
                <div class="text-[14px] font-medium text-[#0b0b0c] group-hover:text-[#8a6a45] transition-colors">info@everridgeus.com</div>
              </div>
            </a>

            <a href="https://maps.google.com/?q=Clinton+Township+MI" target="_blank" rel="noopener noreferrer"
               class="flex items-start gap-4 group">
              <div class="w-10 h-10 bg-white border border-[#e6e3df] flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:border-[#8a6a45] transition-colors">
                <svg class="w-4 h-4 text-[#8a6a45]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <!-- Hours -->
        <div class="bg-[#f5f2ef] border border-[#e6e3df] p-7">
          <h3 class="font-['Articulat_CF'] text-[17px] font-bold text-[#0b0b0c] mb-4">Business Hours</h3>
          <?php
          $hours = [
          ...
          <div class="flex flex-col gap-3">
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="text-[13px] font-light <?php echo $h['time'] === 'Closed' ? 'text-[#c0392b]' : 'text-[#7a7f85]'; ?>">
                <?php echo $h['time']; ?>
              </span>
            </div>
            <?php if ( $h !== end($hours) ) : ?>
        ...
        <div class="bg-[#f5f2ef] border border-[#e6e3df] p-6">
          ...
          <div class="flex gap-3">
            ...
            <a href="<?php echo $s['href']; ?>" target="_blank" rel="noopener noreferrer"
               ...
               class="w-10 h-10 bg-white border border-[#e6e3df] flex items-center justify-center text-[#7a7f85] hover:text-[#8a6a45] hover:border-[#8a6a45] transition-colors">
...
<section class="bg-[#f5f2ef] border-t border-[#e6e3df] py-16">
  <div class="max-w-[1280px] mx-auto px-6 md:px-10">
    ...
    <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
      ...
      <span class="text-[12px] font-medium text-[#2f3133] bg-white border border-[#e6e3df] px-4 py-1.5">
        <?php echo $city; ?>, MI
      </span>
      <?php endforeach; ?>
    </div>
...
<section class="bg-[#0b0b0c] py-16">
  <div class="max-w-[900px] mx-auto px-6 md:px-10 text-center">
    <h2 class="font-['Articulat_CF'] text-[clamp(24px,4vw,40px)] font-bold text-[#e6e3df] leading-[1.15] mb-4">
      Prefer to Talk First?<br>
      <span class="text-[#8a6a45]">We're Easy to Reach.</span>
    </h2>
